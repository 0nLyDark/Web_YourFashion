import { List, useRecordContext, Link, Datagrid, TextField, ImageField, NumberField, Create, Edit, SimpleForm, TextInput,
    ...
    <List filters={postFilters}>
        <Datagrid rowClick={false}>
            ...
            <FunctionField source="description" label="Description" render={record => truncate(record.description, 25)} />
...
export const ProductCreate = () => (
    <Create>
        <SimpleForm>
            ...
            <TextInput source="description" label="Description (Product Description must contain atleast 6 characters)" multiline  />
        ...
        return (
            <Edit>
                <SimpleForm>
                    ...
                    <TextInput source="category.categoryName" label="Category" disabled />
