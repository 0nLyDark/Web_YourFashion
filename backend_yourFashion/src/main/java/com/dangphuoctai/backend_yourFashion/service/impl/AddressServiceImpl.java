...
import com.dangphuoctai.backend_yourFashion.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
    ...
    public AddressDTO createAddress(AddressDTO addressDTO) {
        ...
        Address addressFromDB = addressRepo.findByCountryAndDistrictAndCityAndPincodeAndWardAndBuildingName(country,
        district, city, pincode, ward, buildingName);
    ...
    public AddressDTO updateAddress(Long addressId, Address address) {
        Address addressFromDB = addressRepo.findByCountryAndDistrictAndCityAndPincodeAndWardAndBuildingName(
                address.getCountry(), address.getDistrict(), address.getCity(), address.getPincode(), address.getWard(),
